    ...
    async def root() -> Dict[str, Any]:
        ...
        return {
            ...
            "endpoints": {
                ...
                "GET /health": "Health check (no x-request-id required)",
                "GET /ready": "Readiness check (no x-request-id required)",
                "GET /metrics/security": "Security metrics (requires x-request-id header)",
                "POST /execute": "Execute tool request through security pipeline (requires x-request-id header)",
            },
            "required_header": "x-request-id (except for /, /health, /ready, /docs, /openapi.json)",
            "docs": {
                "swagger_ui": "/docs",
